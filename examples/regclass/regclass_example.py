...
clf_weight = DistributionalRegressorAsClassifier(
    reg, thresholds=[0], decision_strategy="weighted"
)
...
clf_prob = DistributionalRegressorAsClassifier(
    reg, thresholds=[0], decision_strategy="probabilistic"
)
...
clf_weight_mc = DistributionalRegressorAsClassifier(
    reg_multiclass, thresholds=multiclass_thresholds, decision_strategy="weighted"
)
...
clf_prob_mc = DistributionalRegressorAsClassifier(
    reg_multiclass, thresholds=multiclass_thresholds, decision_strategy="probabilistic"
)
