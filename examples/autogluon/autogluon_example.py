...
from tabpfn_extensions.autogluon import AutogluonTabPFNClassifier, AutogluonTabPFNRegressor
...
print("Normal TabPFN ROC AUC:", roc_auc_score(y_test, normal_tabpfn_proba[:, 1]))
print("Normal TabPFN Accuracy:", accuracy_score(y_test, normal_tabpfn_preds))

print("\n--- Using AutogluonTabPFNClassifier (TabPFN with AutoGluon) ---")
clf = AutogluonTabPFNClassifier(max_time=60 * 3)
...
print("Normal TabPFN ROC AUC:",  roc_auc_score(y_test, normal_tabpfn_proba, multi_class="ovr"))
print("Normal TabPFN Accuracy:", accuracy_score(y_test, normal_tabpfn_preds))
...
print("Mean Squared Error (MSE):", mean_squared_error(y_test, normal_tabpfn_preds))
print("Mean Absolute Error (MAE):", mean_absolute_error(y_test, normal_tabpfn_preds))
print("R-squared (R^2):", r2_score(y_test, normal_tabpfn_preds))

print("\n--- Using AutogluonTabPFNRegressor (TabPFN with AutoGluon) ---")
reg = AutogluonTabPFNRegressor(max_time=60 * 3)
