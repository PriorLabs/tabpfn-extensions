...
try:
    ...
    TabPFGen = None
    print(f"TabPFGen import failed: {e}")  # Debug info
...
class TabPFNDataSynthesizer:
    ...
    def generate_classification(
        ...
        if visualize and TABPFGEN_AVAILABLE:
            try:
                ...
                warnings.warn(f"TabPFGen visualization failed: {e}")
    ...
    def balance_dataset(
        ...
        if target_per_class is None:
            ...
            X_synth, y_synth, X_combined, y_combined = self.generator.balance_dataset(X, y)
        else:
        ...
        print(f"Final class distribution: {dict(zip(final_unique, final_counts))}")
